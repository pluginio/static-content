...
We have made the bold decision to make our design system free and open-source under the MIT lisense. Early adopters can start using the AIR design system in their personal projects and/or Plugin.IO apps today. Get started today at: [https://air.plugin.io](https://air.plugin.io)
